...
export const PLATE_RECOGNIZER_API_TOKEN = process.env.REACT_APP_PLATE_RECOGNIZER_API_TOKEN || '877866e9d8d7040725188a3b6469f3234c47d05f';
...
export const USDOT_OCR_API_TOKEN = process.env.REACT_APP_USDOT_OCR_API_TOKEN || '9845f71a9eccd3bfbdfb7731b376cbcd8e52ddbc';
